 ...
 *
 */
public class DNAMirrorGrouping extends Configured implements Tool{
	...
	public static void main(String[] args) throws Exception {
		System.out.println("*******DNA-Mirroring-Job starts********");
		System.exit(ToolRunner.run(new Configuration(), new DNAMirrorGrouping(), args));
		System.out.println("********DNA-Mirroring-Job ends********");
	}

	@Override
	public int run(String[] args) throws Exception {
		Configuration conf = getConf();
		Job job = Job.getInstance(conf, "DNA-Mirroring-Job");
